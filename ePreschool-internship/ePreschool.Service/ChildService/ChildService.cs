...
namespace ePreschool.Service
{
    public class ChildService : BaseService<Child, ChildDto>, IChildService
    {
        ...
        public ChildService(IMapper mapper, IUnitOfWork unitOfWork) : base(mapper, unitOfWork)
        {
            _currentRepository = _childRepository = ((UnitOfWork)unitOfWork)._childRepository;
        }
